from Strategies.LI_2024_07_TwoMlExample import *
...
WFO = WalkForwardOptimization(df, TwoMlExample, params_fixed, params_range,length_train_set=5_000, randomness=1.00)
