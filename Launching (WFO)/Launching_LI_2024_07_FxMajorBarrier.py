from Strategies.LI_2024_07_FxMajorBarrier import *
...
WFO = WalkForwardOptimization(df, FxMajorBarrier, params_fixed, params_range,length_train_set=5_000, randomness=1.00, anchored=False)
