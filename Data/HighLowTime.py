...
df_low_tf = pd.read_csv("FixTimeBars/USDCHF_30M_Admiral.csv", index_col="time", parse_dates=True)
df_high_tf = pd.read_csv("FixTimeBars/USDCHF_4H_Admiral.csv", index_col="time", parse_dates=True)

df = find_timestamp_extremum(df_high_tf, df_low_tf)

print(df[["high_time", "low_time"]])
df.to_csv("FixTimeBars/USDCHF_4H_Admiral_READY.csv")
